...
impl Color {
    pub fn rgb_255f(r: f64, g: f64, b: f64) -> Self {
        Self::rgb_255u(r as u32, g as u32, b as u32)
    }

    pub fn rgb_255u(r: u32, g: u32, b: u32) -> Self {
        Color((r << 16) | (g << 8) | b)
    }

    pub fn rgb_norm(r: f64, g: f64, b: f64) -> Self {
        Self::rgb_255u((r * 255.) as u32, (g * 255.) as u32, (b * 255.) as u32)
    }

    pub fn vec_norm(v: Vec3) -> Self {
        Self::rgb_norm(v.x(), v.y(), v.z())
    }

    pub fn as_u32_slice(colors: &[Color]) -> &[u32] {
